...
//! контроль не зависит от состояния `C4`: он станет зелёным сразу, как появится форма
//! политики (задача 12), и будет сторожить разницу двух механизмов дальше — независимо
//! от того, сделана ли задача 13.
//!
//! **ПОПРАВКА (`C-247` R2).** Здесь стояло «контроль работает УЖЕ СЕГОДНЯ». Утверждение
//! было верным ровно один круг: после приведения всех конструкторов политики к
//! шестипольной форме (`C-246` R1) файл тоже COMPILE-RED до задачи 12. Я снял это
//! утверждение в спеке, но не здесь — и гейт поймал ровно тот класс, против которого
//! заведён весь этот милестоун: утверждение о состоянии, пережившее своё основание.
//! Текст заменён на проверяемый.
//!
