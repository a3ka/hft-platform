...
/// Манифест этого файла. Сверку с таблицей §4.2 спеки гейт M-62 делал НА ПРИЁМКЕ; сам гейт
/// сдан в архив по норме Р-2 (`docs/archive/verify_M-62.sh`) и больше не исполняется
