...
battery() {
  local mutants=(
    ...
    'G1-сторож-молчит~|~H:[ "${found}" = "1" ]~|~false~|~~|~~|~L11-нечитаемый-cwd-свой L12-алиас-того-же-каталога L2-живой-в-дереве L2-каталог-уцелел L3-живой-в-подкаталоге L5-cwd-deleted L8-reclaim-живой L8-target-уцелел'
