...
# ЧЕТЫРЕ имени разделов, объявленные барьером (`check_milestone_shape.sh:183-186`). Перечень
...
# ЧЕТЫРЕ формы сырого HTML, объявленные барьером (`check_milestone_shape.sh:160`).
