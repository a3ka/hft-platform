...
### F6 → ЗАКРЫТ ПО СУЩЕСТВУ, и закрыт замером, а не переформулировкой (долг — **TD-072**)
...
дефект, не проектирую фикс). Заведён **TD-071** (номера ниже 071 заняты — сверено по `TECH-DEBT.md`).
