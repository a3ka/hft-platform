...
дефект, не проектирую защиту). Занесено в `TECH-DEBT.md` как **TD-060**.
...
долгом; заведён отдельной записью в `TECH-DEBT.md` (**TD-061**).
...
поведения валидатора апстримом придёт в CI незамеченной. Внесено в TD-060 как пункт «б».
