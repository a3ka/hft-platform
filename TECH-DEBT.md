...
- **TD-098** `cancel_fraction-слепа-к-перерождению-уровня-метрика-смещена-в-сторону-вывода`
...
- **TD-099** `funding-breadth-не-наблюдаема-ни-оракулом-ни-алертом`
...
- **TD-100** `пропуск-PR-гейта-обнаруживаем-но-не-предотвратим`
