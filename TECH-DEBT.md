...
- **TD-042** `windowed-snapshot-apply-double-counts-evicted-cvd-prefix` (найдено reviewer'ом на PR-гейте
  M-37 rev2, 2026-07-27). **БЛОКЕР M-37 (CHANGES REQUESTED).** **Класс «идеальная фикстура» —
...
- **TD-040** `bounded-oracle-green-locally-red-on-CI` (найдено reviewer'ом на PR-гейте M-37, 2026-07-27).
  **✅ ФИКС ПРИНЯТ reviewer'ом локально 2026-07-27 (`c5d9ab8`, architect); закрытие — после зелёного CI**
  (M-37 не смержен из-за TD-042, поэтому CI на main по этому коду ещё не прогонялся). Фикс бьёт ровно в
