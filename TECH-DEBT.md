...
- **TD-069** `пруф-якорь-принятого-документа-живёт-на-несмёрженной-ветке` (заведено reviewer'ом,
  `R-019` F1/F2, 2026-08-02; **блокирует** merge CT-RFC-06, ветка `docs/ct-rfc-06-l2delta`).
