...
- **TD-049** `zst-хвост-фейлит-старт-recorder-где-сырой-терпит` (найдено reviewer'ом на PR-гейте M-40,
  ...
  процедура) проектирует **architect** RED-first. Severity: MINOR→MAJOR по последствию (остановка сбора),
  MINOR по достижимости (только restore-путь, ручной и наблюдаемый).
