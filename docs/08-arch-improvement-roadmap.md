...
- **0b. R2 + R2b → `M-40`** — RED (retention над смесью raw+.zst; restore-drill поверх сжатой
...
| 0b | R2 + R2b | `M-40-retention-compaction-dedup` | SPEC READY (RED красный, dev не начат) |
