...
`TD-PARSER-BLOCK` и мёртвая константа `TD_PAT` — заведены как `TD-130` (MINOR, за
architect'ом). Кругом 5-fix добавлен `TD-131` (MAJOR): шаги N и S гейта `verify_M-61.sh`
