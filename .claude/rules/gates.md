...
Статус-колонки §Tasks; close-out отчёты по факту; `PROJECT-STATE.md`/`TECH-DEBT.md`
(reviewer-owned); опечатки/формат/битые ссылки; добавление ПРУФОВ (сырые логи §8) в уже
принятый документ.
