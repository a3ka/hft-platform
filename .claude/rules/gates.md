...
- Проверено на 5 сценариях: add→delete внутри ветки → FAIL; увод переименованием → FAIL; override
  в другом коммите → FAIL; override в том же коммите → PASS; переезд protected→protected → PASS.
