...
- **Барьер сам под пробой** — `scripts/tests/red_protected_artifacts.sh` (10 сценариев, зовёт
  барьер ТОЙ ЖЕ проводкой, что CI; отдельный шаг того же job'а). Анти-плацебо: против пред-фиксной
  проводки проба падает 7/10, против исправленной — 10/10.
